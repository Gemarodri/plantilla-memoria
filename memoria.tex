...
Tras seguir el procedimiento descrito anteriormente, obtenemos una lista con los posibles identificadores de commit causantes del error. El siguiente paso es analizar cada uno de los commits y clasificarlos en uno de estos tres grupos, dependiendo de su responsabilidad en la aparición del error. 
\begin{enumerate}
